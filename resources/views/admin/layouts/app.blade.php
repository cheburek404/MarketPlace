...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="https://cent.kz/images/logo.png" alt="AdminLTELogo" height="80" width="200">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="https://cent.kz/images/logo.png" alt="Admin Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
